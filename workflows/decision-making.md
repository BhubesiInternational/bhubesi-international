...
- Commits budget beyond a business unit's discretionary authority.
- Creates legal, regulatory, or reputational exposure.
- Changes strategic direction, brand, or scope of a project or business unit.
- Cannot be resolved by one person or one unit alone.

See [`../docs/governance.md`](../docs/governance.md) for the full decision-rights matrix.
...
5. **Record the decision.** Log it using [`../templates/decision-log-template.md`](../templates/decision-log-template.md), including who decided, when, and why.
6. **Communicate the outcome** to affected business units/projects.
7. **Revisit if assumptions change.** If a material assumption behind the decision turns out to be wrong, reopen it rather than letting stale decisions stand.

## Escalation Path

Business Unit / Project Lead → Executive Office function owner (Strategy / Finance / Legal / Governance / HR) → full Executive Office, as needed based on the scale of the decision.
